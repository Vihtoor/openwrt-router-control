...
# Let's insert before the end of getDialogBody
if '"devices" -> when' not in content[content.find("fun getDialogBody"):]:
    content = content.replace("            else -> \"\"", devices_body + "            else -> \"\"")
